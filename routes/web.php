...
Route::middleware('auth')->group(function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::get('lelang/create/{asset}', [LelangController::class, 'create'])->middleware('auth')->name('lelang.create');
...
Route::post('admin/lelang/{asset}', [LelangController::class, 'store'])->middleware('auth')->name('lelang.store');
